...
EXAMPLES_USER = os.getenv("SUPERSET_EXAMPLES_USER")
EXAMPLES_PASSWORD = os.getenv("SUPERSET_EXAMPLES_PASSWORD")
EXAMPLES_HOST = os.getenv("SUPERSET_EXAMPLES_HOST")
EXAMPLES_PORT = os.getenv("SUPERSET_EXAMPLES_PORT")
EXAMPLES_DB = os.getenv("SUPERSET_EXAMPLES_DB")
